...
class MemberController extends Controller
{
    ...
    public function home()
    {
        ...
        $booking['pending'] = Booking::where('status', '!=', 0)->where('working_status', 0)->where('member_id', $user->id)->count();
        $booking['complete'] = Booking::where('status', '!=', 0)->where('working_status', 1)->where('member_id', $user->id)->count();
        ...
        $transaction = Transaction::where('user_id', $user->id)->orderBy('id', 'DESC')->take(6)->get();
        return view($this->activeTemplate . 'user.member.dashboard', compact('page_title', 'totalTransaction', 'transaction', 'booking', 'withdraw', 'deposit'));
    }
    ...
    public function transaction()
    {
        ...
        $user = Auth::user();
        $transaction = Transaction::where('user_id', $user->id)->latest()->paginate(getPaginate())
        ;
        return view($this->activeTemplate . 'user.member.transaction', compact('page_title', 'transaction'));
    }

    public function profile()
    {
      $page_title = "Member Profile Setting";
      $user = Auth::user();
      return view($this->activeTemplate. 'user.member.profile-setting', compact('page_title', 'user'));
    }
    ...
    public function profileUpdate(Request $request)
    {
        ...
        $user->about_profession = $request->about_profession;
    ...
    public function changePassword()
    {
        ...
        return view($this->activeTemplate . 'user.member.chnage-password', $data);
    }
    ...
    public function depositHistory()
    {
        ...
        return view($this->activeTemplate . 'user.member.deposit_history', compact('page_title', 'empty_message', 'logs'));
    }
    ...
    public function withdrawMoney()
    {
        ...
        return view(activeTemplate() . 'user.member.withdraw.methods', $data);
    }
    ...
    public function withdrawStore(Request $request)
    {
        ...
        return redirect()->route('user.member.withdraw.preview');
    }
    ...
    public function withdrawPreview()
    {
        ...
        return view($this->activeTemplate . 'user.member.withdraw.preview', $data);
    }
    ...
    public function withdrawSubmit(Request $request)
    {
        ...
        return redirect()->route('user.member.withdraw.history')->withNotify($notify);
    }
    ...
    public function withdrawLog()
    {
        ...
        return view($this->activeTemplate.'user.member.withdraw.log', $data);
    }
    ...
    public function show2faForm()
    {
        ...
        return view($this->activeTemplate.'user.member.twofactor', compact('page_title', 'secret', 'qrCodeUrl', 'prevcode', 'prevqr'));
    }
