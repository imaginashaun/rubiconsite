...
class UserController extends Controller
{
    ...
    public function home()
    {
        ...
        $booking['complete'] = Booking::where('status', '!=', 0)->where('user_id', $user->id)->where('working_status', 1)->count();
        $booking['pending'] = Booking::where('status', '!=', 0)->where('user_id', $user->id)->where('working_status', 0)->count();
        $booking['inprogress'] = Booking::where('status', '!=', 0)->where('user_id', $user->id)->where('working_status', 3)->count();
        $withdraw = Withdrawal::where('user_id', $user->id)->where('status', 1)->sum('amount');
        return view($this->activeTemplate . 'user.journalist.dashboard', compact('page_title','transaction_count', 'transaction', 'booking', 'withdraw'));
    }
    ...
    public function transaction()
    {
        ...
        ;
        return view($this->activeTemplate . 'user.journalist.transaction', compact('page_title', 'transaction'));
    }
    ...
    public function profile()
    {
        ...
        return view($this->activeTemplate. 'user.journalist.profile-setting', compact('page_title', 'user', 'service'));
    }
    ...
    public function submitProfile(Request $request)
    {
        ...
        $request->validate([
            ...
            'skill' => 'required|array|max:15',
            'language' => 'required|array|max:10',
    ...
    public function changePassword()
    {
        ...
        return view($this->activeTemplate . 'user.journalist.password', $data);
    }
    ...
    public function withdrawMoney()
    {
        ...
        return view(activeTemplate() . 'user.journalist.withdraw.methods', $data);
    }
    ...
    public function withdrawPreview()
    {
        ...
        return view($this->activeTemplate . 'user.journalist.withdraw.preview', $data);
    }
    ...
    public function withdrawLog()
    {
        ...
        return view($this->activeTemplate.'user.journalist.withdraw.log', $data);
    }
    ...
    public function show2faForm()
    {
        ...
        return view($this->activeTemplate.'user.journalist.twofactor', compact('page_title', 'secret', 'qrCodeUrl', 'prevcode', 'prevqr'));
    }
