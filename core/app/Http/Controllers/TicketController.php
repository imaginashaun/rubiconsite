...
class TicketController extends Controller
{
    ...
    public function supportTicket()
    {
        ...
        if($user)
        {
            ...
            {
                return view($this->activeTemplate . 'user.member.support.index', compact('page_title', 'supports'));
            }
            elseif($user->user_type == "journalist")
            {
                return view($this->activeTemplate . 'user.journalist.support.index', compact('page_title', 'supports')); 
            }
            else{
                abort(404);
            }
    ...
    public function openSupportTicket()
    {
        ...
        if($user)
        {
            if($user->user_type == "member")
            {
                return view($this->activeTemplate . 'user.member.support.create', compact('page_title', 'user'));
            }
            elseif($user->user_type == "journalist")
            {
                return view($this->activeTemplate . 'user.journalist.support.create', compact('page_title', 'user')); 
            }
            else{
                abort(404);
            }
    ...
    public function viewTicket($ticket)
    {
        ...
        if($user)
        {
            if($user->user_type == "member")
            {
                return view($this->activeTemplate. 'user.member.support.view', compact('my_ticket', 'messages', 'page_title'));
            }
            elseif($user->user_type == "journalist")
            {
                return view($this->activeTemplate. 'user.journalist.support.view', compact('my_ticket', 'messages', 'page_title'));
            }else{
                abort(404);
            }
        }
