...
<div class="row justify-content-center">
    @if(request()->routeIs('admin.deposit.list') || request()->routeIs('admin.deposit.method') || request()->routeIs('admin.member.users.deposits') || request()->routeIs('admin.deposit.dateSearch') || request()->routeIs('admin.member.users.deposits.method'))
                ...
                <div class="table-responsive--sm table-responsive">
                    <table class="table table--light style--two">
                        ...
                        <tr>
                            ...
                            @if(!request()->routeIs('admin.member.users.deposits') && !request()->routeIs('admin.member.users.deposits.method'))
                            ...
                            @elseif(request()->routeIs('admin.deposit.list') || request()->routeIs('admin.deposit.search') || request()->routeIs('admin.member.users.deposits') || request()->routeIs('admin.deposit.method') || request()->routeIs('admin.deposit.dateSearch') || request()->routeIs('admin.member.users.deposits.method'))
                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                @if(!request()->routeIs('admin.users.deposits') && !request()->routeIs('admin.member.users.deposits.method'))
                                <td data-label="@lang('Username')"><a href="{{ route('admin.member.users.detail', $deposit->user_id) }}">{{ $deposit->user->username }}</a></td>
                                @endif
                                <td data-label="@lang('Method')">
                                    @if(request()->routeIs('admin.member.users.deposits') || request()->routeIs('admin.member.users.deposits.method'))
                                   <a href="{{ route('admin.member.users.deposits.method',[$deposit->gateway->alias,@$type?$type:'all',$userId]) }}">{{ __($deposit->gateway->name) }}</a>
                                   @else
                                ...
                                @elseif(request()->routeIs('admin.deposit.list')  || request()->routeIs('admin.deposit.search') || request()->routeIs('admin.users.deposits') || request()->routeIs('admin.deposit.method') || request()->routeIs('admin.deposit.dateSearch') || request()->routeIs('admin.member.users.deposits.method'))
