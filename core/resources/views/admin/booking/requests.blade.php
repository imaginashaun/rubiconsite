                            ...
                            <tr>
                              ...
                              <td data-label="@lang('Status')">
                                  ...
                                  @elseif($booking->status == 7)
                                      <span class="font-weight-normal badge--success">@lang('Pending Admin Approval')</span>
                                    @endif
                               </td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">@lang('Approve Booking')</h5>
                                                    ...
                                                    <form action="{{ route('admin.users.booking.store')}}" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            <p class="text text-warning">Are you sure you want to approve this request?</p>
                                                        </div>
