            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.pending.stories', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$stories['pending']}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Pending Stories')</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.stories', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$stories['complete']}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Stories')</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--11 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.video', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$video}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Video Work')</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--7 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.audio', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$audio}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Audio Work')</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--6 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.blog', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$blog}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Blog Link')</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--1 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.image', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$image}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Image Work')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--10 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.booking.pending', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            ...
                            <div class="desciption">
                                <span>@lang('Total Booking Pending')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--15 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.booking.complete', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            ...
                            <div class="desciption">
                                <span>@lang('Total Booking Complete')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--3 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.booking.inprogress', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            ...
                            <div class="desciption">
                                <span>@lang('Total Booking Inprogress')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--19 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.users.booking.expired', $user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$booking['Expired']}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Booking Expired')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.users.update',[$user->id])}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group  col-md-4 col-sm-4 col-12">
                                <label class="form-control-label font-weight-bold">@lang('Account Approval status') </label>
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       data-toggle="toggle" data-on="Approved" data-off="Banned" name="account_status"
                                       @if($user->account_status) checked @endif>
                            </div>
