        ...
        <div class="col-lg-12">
            <div class="card b-radius--10 ">
                        ...
                        @forelse($audios as $value)
                            <tr>
                                ...
                                <td data-label="@lang('Audio')">
                                  <audio controls>
                                    <source src="{{ asset('assets/audio/'.$value->audio_file )}}" type="audio/mpeg">
                                  </audio>
                                </td>
                                ...
                                <td data-label="@lang('Action')">
                                  <a href="{{route('admin.work.audio.detail', $value->id)}}" class="icon-btn btn--primary ml-2" data-toggle="tooltip" title="" data-original-title="Details">
                ...
                <div class="card-footer py-4">
                    {{ $audios->links('admin.partials.paginate') }}
                </div>
            </div><!-- card end -->
        </div>
    </div>
...
<div id="deleteVideo" class="modal fade" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           <form action="{{route('admin.work.audio.delete')}}" method="POST">
               @csrf
...
<div id="approvedVideo" class="modal fade" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           <form action="{{route('admin.work.audio.approvedBy')}}" method="POST">
               @csrf
               <input type="hidden" name="id" value="">
               <div class="modal-body">
                   <p>@lang('Are you sure want to approved this audio?')</p>
               </div>
               <div class="modal-footer">
                   <button type="button" class="btn btn--danger text-white" data-dismiss="modal">@lang('Close')</button>
