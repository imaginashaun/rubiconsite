                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Username')
                            <span class="font-weight-bold">{{$ima->user->username}}</span>
                        </li>

                         <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Account Approval status')
                            @switch($ima->user->account_status)
                                @case(1)
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-center">
                        <img src="{{ getImage('assets/images/workFile/'. $ima->image)}}" alt="profile-image"
                            class="img-thumbnail">
                    </div>
                    <div class="card-title my-4"><b>@lang('Title')</b></div>
                    <h4>{{__($ima->title)}}</h4>
                    <div class="card-title my-4"><b>@lang('Description') </b></div>
                    <div class="card-text">@php echo $ima->descripation @endphp</div>
                </div>
            </div>
        </div>
    </div>
