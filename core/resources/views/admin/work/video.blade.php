                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Journalist Username')"><a href="{{ route('admin.users.detail', $value->user_id) }}">{{ $value->user->username }}</a></td>
                                <td data-label="@lang('Video')">
                                    <a href="{{$value->video_file}}" data-rel="lightcase:myCollection" class="icon-btn btn--primary"><i class="las la-play"></i></a>
                                ...
                                <td data-label="Action">
                                  <a href="{{route('admin.work.video.detail', $value->id)}}" class="icon-btn btn--primary ml-2" data-toggle="tooltip" title="" data-original-title="Details">
...
<div id="deleteVideo" class="modal fade" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           <form action="{{route('admin.work.video.delete')}}" method="POST">
               @csrf
...
<div id="approvedVideo" class="modal fade" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           <form action="{{route('admin.work.video.approvedBy')}}" method="POST">
               @csrf
               <input type="hidden" name="id" value="">
               <div class="modal-body">
                   <p>@lang('Are you sure want to approved this video?')</p>
               </div>
               <div class="modal-footer">
                   <button type="button" class="btn btn--danger text-white" data-dismiss="modal">@lang('Close')</button>
