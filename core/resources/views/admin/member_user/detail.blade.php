...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        <div class="">
                            <img src="{{ getImage(imagePath()['profile']['user']['path'].'/'.$member_users->image,imagePath()['profile']['user']['size'])}}" alt="@lang('Profile Image')" class="b-radius--10 w-100">
                        </div>
                        <div class="mt-15">
                            <h4 class="">{{@$member_users->fullname}}</h4>
                            <span class="text--small">@lang('Joined At') <strong>{{showDateTime($member_users->created_at,'d M, Y h:i A')}}</strong></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Username')
                            <span class="font-weight-bold">{{$member_users->username}}</span>
                        </li>


                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Status')
                            @switch($member_users->status)
                                @case(1)
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Balance')
                            <span class="font-weight-bold">{{getAmount($member_users->balance)}}  {{__($general->cur_text)}}</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Member action')</h5>
                    <a data-toggle="modal" href="#addSubModal" class="btn btn--success btn--shadow btn-block btn-lg">
                        @lang('Add/Subtract Balance')
                    </a>
                    <a href="{{ route('admin.member.users.login.history.single', $member_users->id) }}"
                       class="btn btn--primary btn--shadow btn-block btn-lg">
                        @lang('Login Logs')
                    </a>
                    <a href="{{route('admin.member.users.email.single',$member_users->id)}}"
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            ...
            <div class="row mb-none-30">
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--deep-purple b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.member.users.deposits',$member_users->id)}}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--indigo b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.member.users.withdrawals',$member_users->id)}}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--12 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.member.users.transactions',$member_users->id)}}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.member.users.booking', $member_users->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-exchange-alt"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$totalBooking}}</span>
                            </div>
                            <div class="desciption">
                                <span>@lang('Total Booking Journalist')</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mt-50">
                <div class="card-body">
                    <h5 class="card-title mb-50 border-bottom pb-2">{{$member_users->fullname}} @lang('Information')</h5>

                    <form action="{{route('admin.member.users.update',[$member_users->id])}}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="firstname" value="{{$member_users->firstname}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lastname" value="{{$member_users->lastname}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="email" name="email" value="{{$member_users->email}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="mobile" value="{{$member_users->mobile}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="address" value="{{@$member_users->address->address}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Website (Optional)') </label>
                                    <input class="form-control" type="text" name="website" value="{{@$member_users->website}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="city" value="{{@$member_users->address->city}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="state" value="{{@$member_users->address->state}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control" type="text" name="zip" value="{{@$member_users->address->zip}}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xl-4 col-md-6  col-sm-3 col-12">
                                ...
                                <input type="checkbox" data-onstyle="-success" data-offstyle="-danger"
                                       ...
                                       name="status"
                                       @if($member_users->status) checked @endif>
                            </div>
                            ...
                            <div class="form-group  col-xl-4 col-md-6  col-sm-3 col-12">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       ...
                                       @if($member_users->ev) checked @endif>
                            ...
                            <div class="form-group  col-xl-4 col-md-6  col-sm-3 col-12">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       ...
                                       @if($member_users->sv) checked @endif>
                            ...
                            <div class="form-group  col-md-6  col-sm-3 col-12">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       ...
                                       @if($member_users->ts) checked @endif>
                            </div>
                            ...
                            <div class="form-group  col-md-6  col-sm-3 col-12">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       ...
                                       @if($member_users->tv) checked @endif>
                            </div>
                        </div>
    ...
    <div id="addSubModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.member.users.addSubBalance', $member_users->id)}}" method="POST">
                    @csrf
...
@push('script')
    <script>
        "use strict";
        $("select[name=country]").val("{{ @$member_users->address->country }}");
    </script>
@endpush
