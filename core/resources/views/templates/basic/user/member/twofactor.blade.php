    ...
    <div class="container">
        <div class="row justify-content-center">
                ...
                @if(Auth::user()->ts)
                    <div class="card">
                        <div class="card-header bg--6 text-white">
                            <h6 class="card-title">@lang('Two Factor Authenticator')</h6>
                        </div>
                        <div class="card-body">
                            <div class="form-group mx-auto text-center">
                                <a href="#0"  class="btn cmn-btn" data-toggle="modal" data-target="#disableModal">
                ...
                @else
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mx-auto text-center">
                                <button class="btn bg--5 text-white" data-toggle="modal" data-target="#enableModal">@lang('Enable Two Factor Authenticator')</button>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header bg--6 text-white">
                        <h6 class="card-title">@lang('Google Authenticator')</h6>
                    </div>
                    <div class=" card-body">
                        ...
                        <a class="cmn-btn btn-md mt-3" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en" target="_blank">@lang('DOWNLOAD APP')</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="enableModal" class="modal fade" role="dialog">
        <div class="modal-dialog ">
            ...
            <div class="modal-content ">
                ...
                <form action="{{route('user.member.twofactor.enable')}}" method="POST">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn bg--5 text-white">@lang('Verify')</button>
                    </div>
                </form>
            </div>
    ...
    <div id="disableModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="{{route('user.member.twofactor.disable')}}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" class="form-control" name="code" placeholder="@lang('Enter Google Authenticator Code')">
