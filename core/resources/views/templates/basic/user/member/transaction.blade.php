                    ...
                    <div class="card-body table-responsive--lg p-0">
                            <table class="table style--two white-space-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Amount')"><strong @if($value->trx_type == '+') class="text-success" @else class="text-danger" @endif> {{($value->trx_type == '+') ? '+':'-'}} {{getAmount($value->amount)}} {{$general->cur_text}}</strong></td>
