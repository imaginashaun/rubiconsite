                ...
                <div class="col-lg-3 col-md-3 mb-4">
                    <div class="card card-deposit">
                        ...
                        <div class="card-body card-body-deposit">
                            <img src="{{$data->methodImage()}}" class="card-img-top w-100" alt="{{__($data->name)}}">
                        </div>
                        <div class="card-footer">
                            <a href="javascript:void(0)" data-id="{{$data->id}}" data-resource="{{$data}}"
                               ...
                               data-percent_charge="{{getAmount($data->percent_charge)}}" class=" btn cmn-btn btn-block custom-success deposit" data-toggle="modal" data-target="#exampleModal">
                                @lang('Deposit Now')</a>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('user.member.deposit.insert')}}" method="post">
                @csrf
