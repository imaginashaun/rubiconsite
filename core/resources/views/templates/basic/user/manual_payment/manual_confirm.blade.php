        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card card-deposit ">
                    ...
                    <div class="card-body  ">
                        <form action="{{ route('user.member.deposit.manual.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn cmn-btn btn-block mt-2 text-center">@lang('Pay Now')</button>
                                    </div>
                                </div>
